...
function setup() {
  ...
  path = createSprite(width / 2, 200, 10, 10);
...
function createCash() {
  if (World.frameCount % 200 == 0) {
    ...
    var cash = createSprite(Math.round(random(width - 350, 350), 40, 10, 10));
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    var diamonds = createSprite(Math.round(random(width - 350, 350), 40, 10, 10));
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    var jwellery = createSprite(Math.round(random(width - 350, 350), 40, 10, 10));
...
function createSword() {
  if (World.frameCount % 530 == 0) {
    ...
    var sword = createSprite(Math.round(random(width - 350, 350), 40, 10, 10));
